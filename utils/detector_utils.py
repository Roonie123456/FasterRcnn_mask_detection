...
PATH_TO_LABELS = TRAINED_MODEL_DIR + '/mask_labelmap.pbtxt'
...
def draw_box_on_image(num_masks_detect, score_thresh, scores, boxes, classes, im_width, im_height, image_np):
    ...
    color0 = (255,0,0)
    color1 = (0,50,255)
    for i in range(num_masks_detect):
